...
function drawChart(place_data, place_name) {
	...
	$('#chart-header').html("Bikes stolen in 12 months to September in " + place_name);
	$('#scale-header').html("How bad is bike theft in " + place_name + " compared to other areas?");
	...
	xMax = d3.max(data, function(d) { return d.thefts; });
	...
	svg
		...
		.data(data).enter()  
		  ...
		  .attr("width", function(d) { return x(d.thefts) - margin; })
...
$(document).ready(function(){
	...
	$.getJSON("bikes_data.json", function(data){
